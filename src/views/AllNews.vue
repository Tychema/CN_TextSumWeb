    ...
    async fetchData() {
      ...
      axios.post(url0)
          .then(response => {
            ...
            var tableData1 = response.data['record'].map(item => ({title: item.summary,company:item.company,datetime:item.datetime,url:item.url}));
      ...
      axios.post(url1)
          .then(response => {
            // 从响应中提取标题数据
            var tableData2 = response.data['record'].map(item => ({title: item.summary,company:item.company,datetime:item.datetime,url:item.url}));
      ...
      axios.post(url2)
          .then(response => {
            // 从响应中提取标题数据
            var tableData3 = response.data['record'].map(item => ({title: item.summary,company:item.company,datetime:item.datetime,url:item.url}));
